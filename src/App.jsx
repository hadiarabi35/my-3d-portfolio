...
const CONFIG = {
  ...
  gyroSensitivity: 0.08,  // حساسیت ژیروسکوپ
  touchSensitivity: 0.5,  // حساسیت تاچ
  maxMobileMove: 1.5,     // دامنه حرکت مجاز در موبایل
}
...
const TRANSFORM = {
  ...
  mobile: {
    ...
    rotation: [0, 0, 90], // روتیشن مشابه ویندوز
    scale: 2              // اسکیل متفاوت برای موبایل
  }
}
